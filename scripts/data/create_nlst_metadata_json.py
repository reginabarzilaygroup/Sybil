...
parser.add_argument(
    "--source_json_path",
    type=str,
    default="NLST/nlst_metadata.json",
    help="Path to source json file obtained from running OncoData_Public dicom_metadata_to_json.py",
)
parser.add_argument(
    "--nlst_abnormalities_csv",
    type=str,
    default="NLST/package-nlst-564.2020-01-30/NLST_564/nlst_564.delivery.010220/nlst_564_ct_ab_20191001.csv",
)
parser.add_argument(
    "--nlst_metadata_csv",
    type=str,
    default="NLST/package-nlst-564.2020-01-30/NLST_564/nlst_564.delivery.010220/nlst_564_prsn_20191001.csv",
)
parser.add_argument(
    "--nlst_imagedata_csv",
    type=str,
    default="NLST/package-nlst-564.2020-01-30/NLST_564/nlst_564.delivery.010220/nlst_564_ct_image_info_20191001.csv",
)
parser.add_argument(
    "--test_google_splits",
    type=str,
    default="NLST/Shetty_et_al(Google)/TEST_41591_2019_447_MOESM5_ESM.xlsx; from https://www.nature.com/articles/s41591-019-0447-x#Sec17 (Source Data Fig. 4)",
)
parser.add_argument(
    "--png_path_replace_pattern",
    type=str,
    nargs=2,
    default=["nlst-ct", "nlst-ct-png"],
    help="pattern to replace in the dicom file paths with the file paths for the PNG files",
)

if __name__ == "__main__":
    args = parser.parse_args()

    # dicom to png directory
    ...
    for row_dict in tqdm(source_json):
        ...
        path = row_dict["dicom_path"].replace(find_pattern, replace_with) + ".png"
